...
const museDesignProject = {
  ...
  carouselStyle: {
    ...
    individual: [
      { backgroundColor: "white", paddingLeft: "100px", paddingRight: "100px" },
      { backgroundColor: "white", paddingLeft: "50px", paddingRight: "50px" },
      { backgroundColor: "white", paddingLeft: "80px", paddingRight: "80px" },
      {},
      {},
